...
#Project : Changes of flora in the Vesuvius National Park           

#I used https://glovis.usgs.gov/ for the database and Sentinel 2 for the analysis
#library used : raster                                                          
...
#NIR
par(mfrow=c(1,2))                    
plotRGB(ves20170517, r=4, g=3, b=2, stretch="lin", main="17/05/2017", axes = TRUE) #17/05/2017              
plotRGB(ves20200701, r=4, g=3, b=2, stretch="lin", main="01/07/2020", axes = TRUE) #01/07/2020  
